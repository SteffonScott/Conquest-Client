...
public class ConquestConnection : MonoBehaviour
{
     private string _playerName { get; set; }
        ...
        private ConquestConnection _connection { get; set; }
        ...
        public bool Connect()
        {
                ...
                while (_connection.ConnectionState != ConquestConnection.ConnectionStatus.Connected);

            return (_connection.ConnectionState == ConquestConnection.ConnectionStatus.Connected);
        }
        /// <summary>
        ...
        public void SendCommand(string _command, string[] _parameters = null)
        {
            ...
            if (this._connection.ConnectionState != ConquestConnection.ConnectionStatus.Connected)
                return;
