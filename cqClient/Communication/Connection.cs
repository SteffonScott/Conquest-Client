...
namespace cqClient
{
    class Connection : IDisposable
    {
        ...
        public delegate void delDataReceived(Connection sender, object data);
        public event delDataReceived DataReceived;
        public delegate void delConnectionStatusChanged(Connection sender, ConnectionStatus status);
        ...
        public Connection(System.Net.IPAddress ip, int port, bool autoreconnect = true)
        {
            this._IP = ip;
            this._Port = port;
        ...
        {
            var r = result.AsyncState as Connection;
            if (r == null)
